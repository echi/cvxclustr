#' Convex Clustering via Accelerated ADMM
#' 
#' \code{cvxclust_admm_acc} performs convex clustering via accelerated ADMM. Let
...
#' @useDynLib cvxclustr
#' @export
cvxclust_admm_acc = function(X,Lambda,V,ix,w,gamma,nu=1,type=2,max_iter=1e2,tol=1e-4) {
